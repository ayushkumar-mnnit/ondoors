...
<form>
  ...
  <div className="form-group">
    ...
    <input type="string" className="form-control" id="exampleFormControlInput1" placeholder="+91 xxxxxxxxxx"/>
  </div>
  <div className="form-group">
  ...
  <div className="form-group">
    ...
    <input type="string" className="form-control" id="exampleFormControlInput1" placeholder="dd/mm/yy, 5pm-7pm"/>
  </div>
</form>

<input id="sbmt" className="btn btn-primary" type="submit" value="Submit"/>
